...
使用该方案需要一定的安卓（Android）的使用基础，如果看不懂下面的文档的，请转到 [QQ（go-cqhttp）](#qqgo-cqhttpqqgo-cqhttp) 并使用 go-cqhttp 来配置 QQ 平台。
...
请参照 [Webrender 文档](/docs/developmeny/webrender#部署) 部署 Webrender。
