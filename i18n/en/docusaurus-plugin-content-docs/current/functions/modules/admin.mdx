---
description: This module can set the robot administrator to manage robots without a group administrator
slug: /admin
---
...
This module can set the robot administrator to perform the function of managing robots without a group administrator being set up.
...
This command can set a member as a robot administrator.
...
This command can remove members as robot administrators.
