...
| allow_bot_auto_approve_group_invite |                     | "https://github.com/Teahouse-Studios/bot/issues/new?assignees=OasisAkari&labels=New&template=add_new_group.yaml&title=[NEW]%3A+" | 申请加入 QQ 群的网址。                                              |
